...
const BMDrawer = () => {
  ...
  console.log(chosenEmployeeOption);

  const handleNewManagementAssigning = (e) => {
    console.log(e);
  };

  const handleFormSubmission = (e) => {
    e.preventDefault();
    formik.setValues({...formik.values,chosenEmployeeOption:chosenEmployeeOption})
    formik.handleSubmit();
  };

  const formik = useFormik({
    initialValues: {
      branchDetailsBranchName: "",
      branchDetailsBranchCode: "",
      ...
      addressDetialsPermanentAddress: "sameAddress",
    },
    onSubmit: (value) => {
          ...
          <Flex gap="20px" flexWrap={"wrap"} w="97%" m="15px auto">
            <Box flex="1 1 200px">
              ...
              <Input
                ...
                value={formik.values.branchDetailsBranchName}
            ...
            <Box flex="1 1 200px">
              ...
              <Input
                ...
                value={formik.values.branchDetailsBranchCode}
                onChange={formik.handleChange}
              />
            </Box>
            <Box flex="1 1 200px">
              ...
              <Input
                ...
                value={formik.values.branchDetailsLocation}
                onChange={formik.handleChange}
              />
            </Box>
          </Flex>
          ...
          <Flex gap="20px" flexWrap={"wrap"} w="97%" m="15px auto">
            <Box flex="1 1 200px">
              ...
              <Input
                ...
                value={formik.values.addressDetailsLineOne}
                onChange={formik.handleChange}
              />
            </Box>
            <Box flex="1 1 200px">
              ...
              <Input
                ...
                value={formik.values.addressDetailsLineTwo}
                onChange={formik.handleChange}
              />
            </Box>
            <Box flex="1 1 200px">
              ...
              <Input
                ...
                value={formik.values.addressDetailsCity}
                position={"relative"}
                onChange={formik.handleChange}
              />
            </Box>
            <Box flex="1 1 200px">
              ...
              <Input
                ...
                value={formik.values.addressDetailsState}
                onChange={formik.handleChange}
              />
            </Box>
            <Box flex="1 1 200px">
              ...
              <Input
                ...
                value={formik.values.addressDetailsPinCode}
                onChange={formik.handleChange}
              />
            </Box>
            <Box flex="1 1 200px">
              ...
              <Input
                ...
                value={formik.values.addressDetailsCountry}
                onChange={formik.handleChange}
              />
            </Box>
            <RadioGroup mt="10px">
              <Radio
                value={formik.values.addressDetialsPermanentAddress}
                name="addressDetialsPermanentAddress"
                onChange={formik.handleChange}
              >
                <Text color="#3D8CD5">
          ...
          <VStack pb="20px" alignItems={"flex-start"}>
            ...
            {!addManagementActive && (
              <Button
                bg="none"
                color="#1C80DD"
                onClick={() => setAddManagementActive(true)}
                _hover={{ bg: "none" }}
              >
                +Add Management
              </Button>
            ...
            {addManagementActive && (
              <Flex w="100%" alignItems={"center"}>
                ...
                <Button
                  ...
                  ml="auto"
                  mr="10px"
                  onClick={handleNewManagementAssigning}
                  _hover={{ bg: "#3BB97C" }}
                >
                  Add
                </Button>
