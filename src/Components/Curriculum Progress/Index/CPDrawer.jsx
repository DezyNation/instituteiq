    ...
    <form onSubmit={formik.handleSubmit}>
      <DrawerContent position={"relative"} maxW="50%">
        ...
        <DrawerBody pl="40px">
          <Stack spacing="24px">
            <Box>
              <FormLabel htmlFor="chapterName" color="#707070">
                Chapter Name
              </FormLabel>
              <Input
                borderRadius={"12px"}
                ...
                <InputGroup pl="50px" ref={newTopicForm}>
                  <Flex flexDirection={"column"} w="80%">
                    ...
                    <Input
                      type="text"
                      placeholder="Type here"
                      id="newCurriculumTopic"
                      name="newCurriculumTopic"
                      value={formik.values.newCurriculumTopic}
                      onChange={formik.handleChange}
                    ></Input>
                    <Box mt="20px" pl="5px">
                      <FormLabel
                        htmlFor="newCurriculumDuration"
                        color="#707070"
                        fontWeight={400}
                        display={"inline"}
                      >
                      ...
                      <Input
                        ...
                        bg="fff"
                        color="black"
                        id="newCurriculumDuration"
                        name="newCurriculumDuration"
                        value={formik.values.newCurriculumDuration}
                        onChange={formik.handleChange}
                      />{" "}
                      <Text display="inline" fontSize="xs">
                        Hours
